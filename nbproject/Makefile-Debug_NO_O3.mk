...
${OBJECTDIR}/code/hook/Hook.o: code/hook/Hook.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/hook/Hook.o code/hook/Hook.cpp
...
${OBJECTDIR}/code/hook/RelationChoiceHook.o: code/hook/RelationChoiceHook.cpp 
	${MKDIR} -p ${OBJECTDIR}/code/hook
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/hook/RelationChoiceHook.o code/hook/RelationChoiceHook.cpp
...
${OBJECTDIR}/code/hook/Hook_nomain.o: ${OBJECTDIR}/code/hook/Hook.o code/hook/Hook.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/hook/Hook_nomain.o code/hook/Hook.cpp;\
	else  \
...
${OBJECTDIR}/code/hook/RelationChoiceHook_nomain.o: ${OBJECTDIR}/code/hook/RelationChoiceHook.o code/hook/RelationChoiceHook.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/hook/RelationChoiceHook_nomain.o code/hook/RelationChoiceHook.cpp;\
	else  \
