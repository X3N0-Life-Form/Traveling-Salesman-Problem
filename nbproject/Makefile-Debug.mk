...
${TESTDIR}/tests/bestFitTests.o: tests/bestFitTests.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/bestFitTests.o tests/bestFitTests.cpp


${TESTDIR}/tests/bestFitTests_testrunner.o: tests/bestFitTests_testrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/bestFitTests_testrunner.o tests/bestFitTests_testrunner.cpp
...
${TESTDIR}/tests/WorstFitTests.o: tests/WorstFitTests.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/WorstFitTests.o tests/WorstFitTests.cpp


${TESTDIR}/tests/WorstFitTests_testrunner.o: tests/WorstFitTests_testrunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/WorstFitTests_testrunner.o tests/WorstFitTests_testrunner.cpp
