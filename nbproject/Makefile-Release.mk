...
${OBJECTDIR}/code/choice/ChoiceStatic.o: code/choice/ChoiceStatic.cpp 
	${MKDIR} -p ${OBJECTDIR}/code/choice
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/choice/ChoiceStatic.o code/choice/ChoiceStatic.cpp
...
${OBJECTDIR}/code/hook/Picker.o: code/hook/Picker.cpp 
	${MKDIR} -p ${OBJECTDIR}/code/hook
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/hook/Picker.o code/hook/Picker.cpp
...
${OBJECTDIR}/code/run/interval/StrategicMemory.o: code/run/interval/StrategicMemory.cpp 
	${MKDIR} -p ${OBJECTDIR}/code/run/interval
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/run/interval/StrategicMemory.o code/run/interval/StrategicMemory.cpp
...
${TESTDIR}/tests/choice_making_tests/ChoiceMakerTests.o: tests/choice_making_tests/ChoiceMakerTests.cpp 
	${MKDIR} -p ${TESTDIR}/tests/choice_making_tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/choice_making_tests/ChoiceMakerTests.o tests/choice_making_tests/ChoiceMakerTests.cpp
...
${OBJECTDIR}/code/choice/ChoiceStatic_nomain.o: ${OBJECTDIR}/code/choice/ChoiceStatic.o code/choice/ChoiceStatic.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/choice/ChoiceStatic_nomain.o code/choice/ChoiceStatic.cpp;\
	else  \
...
${OBJECTDIR}/code/hook/Picker_nomain.o: ${OBJECTDIR}/code/hook/Picker.o code/hook/Picker.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/hook/Picker_nomain.o code/hook/Picker.cpp;\
	else  \
...
${OBJECTDIR}/code/run/interval/StrategicMemory_nomain.o: ${OBJECTDIR}/code/run/interval/StrategicMemory.o code/run/interval/StrategicMemory.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/code/run/interval/StrategicMemory_nomain.o code/run/interval/StrategicMemory.cpp;\
	else  \
